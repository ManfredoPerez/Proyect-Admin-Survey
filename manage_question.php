		...
		<div class="col-lg-12">
			<div class="row">
				<div class="col-sm-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">Pregunta: Tipo de respuesta</label>
							<select name="type" id="type" class="custom-select custom-select-sm">
								<?php if(isset($id)): ?>
								<option value="" disabled="" selected="">Seleccione aquí</option>
								<?php endif; ?>
								<option value="radio_opt" <?php echo isset($type) && $type == 'radio_opt' ? 'selected':'' ?>>Botón de radio/respuesta única</option>
								<option value="check_opt" <?php echo isset($type) && $type == 'check_opt' ? 'selected':'' ?>>Casillas de verificación/respuesta múltiple</option>
