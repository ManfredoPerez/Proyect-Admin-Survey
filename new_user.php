					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Rol</option>
								<option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Personal</option>
...
<script>
	$('[name="password"],[name="cpass"]').keyup(function(){
		...
		if(cpass == '' ||pass == ''){
			...
			if(cpass == pass){
				$('#pass_match').attr('data-status','1').html('<i class="text-success">Contraseña coinciden.</i>')
			}else{
